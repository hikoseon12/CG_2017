 ...
 public void setDtriangle(ArrayList<Triangle> dtr)
 {
  this.triList = dtr;
    ...
    public void drawMan(ArrayList<PntPair> pos, Pnt center, double angle)
    {
     ...
     //System.out.println("최대 팔길이 : "+man.getArmMaxLength()+" 뒷팔길이 : "+man.getBackArmLength()+" 앞팔 길이 : " +man.getFrontArmLength());
     //System.out.println("최대 다리길이 : "+man.getLegMaxLength()+" 뒷다리길이 : "+man.getBackLegLength()+" 앞다리길이 : " +man.getFrontLegLength());
